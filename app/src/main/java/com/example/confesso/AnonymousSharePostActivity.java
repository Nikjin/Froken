...
public class AnonymousSharePostActivity extends AppCompatActivity {

    TextView cat, username, tv_username, tv_title, tv_date;
    EditText edittitle;
    ImageView user_image,publisher_image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Anonymous Posts").child(postid);
    ...
    public void SharePost()
    {
        ...
        reference.child(sharedpostid).setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(AnonymousSharePostActivity.this,"Posted Successfully!",Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();

                    startActivity(new Intent(AnonymousSharePostActivity.this,HomeActivity.class));
                    finish();
                }

                else {
                    Toast.makeText(AnonymousSharePostActivity.this,task.getException().getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void sendNotification(JSONObject notificationJo)
    {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", notificationJo,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(AnonymousSharePostActivity.this,""+ error.toString(), Toast.LENGTH_SHORT).show();
        ...
        //enqeue the volley
        Volley.newRequestQueue(AnonymousSharePostActivity.this).add(jsonObjectRequest);
