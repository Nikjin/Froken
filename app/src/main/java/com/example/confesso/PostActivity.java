...
public class PostActivity extends AppCompatActivity {
  ...
  //  List<String> mention;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image_profile = findViewById(R.id.cprofile);
                                ...
                                for (DataSnapshot snapshot : dataSnapshot.getChildren())
                                {
                                    ...
                                    for (String username : mention) {
                                        ...
                                        if (user.getUsername().equals(username)) {
                                            ...
                                            addNotifications(userid, postid);
...
//yeh wala function imp hai bhot mehnat ki hai isme single user ki details nikal skti hai isse!!
...
// retrieving data from string list array in for loop
    ...
    private void sendNotification(JSONObject notificationJo)
    {
        ...
        //enqeue the volley
        Volley.newRequestQueue(PostActivity.this).add(jsonObjectRequest);
