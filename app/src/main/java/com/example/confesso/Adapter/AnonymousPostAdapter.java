...
import com.example.confesso.AnonymousEditPostsActivity;
import com.example.confesso.AnonymousSharePostActivity;
...
public class AnonymousPostAdapter extends RecyclerView.Adapter<AnonymousPostAdapter.ViewHolder> {

    public Context mContext;
    public List<AnonymousPost> mPost;
    public List<AnonymousPost> mPostFiltered;

    String str_title,saveCurrentTime;
    long difference;
    ...
    public AnonymousPostAdapter(Context mContext, List<AnonymousPost> mPost) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(mContext).inflate(R.layout.anonymouspost_item, viewGroup,false);


        return new AnonymousPostAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        final AnonymousPost post = mPostFiltered.get(i);
        ...
        viewHolder.anonymousimage_profile.setImageResource(imageIds[post.getPicpos()]);
     ...
     /*  if (post.getDescription().equals("")){
        ...
        publisherInfo(viewHolder.anonymous,post.getPublisher(),viewHolder.save,viewHolder.share,viewHolder.shares);
            ...
            public void onClick(View v) {
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        {
                            case R.id.edit:
                                Intent intent = new Intent(mContext, AnonymousEditPostsActivity.class);
                            ...
                            case R.id.delete:
                                ...
                                FirebaseDatabase.getInstance().getReference("Notifications")
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        FirebaseDatabase.getInstance().getReference("Anonymous Posts")
                                                .child(post.getPostid()).removeValue()
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    @Override
                                                    public void onComplete(@NonNull Task<Void> task) {
        ...
        viewHolder.share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mContext, AnonymousSharePostActivity.class);
                intent.putExtra("postid",post.getPostid());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private ImageView anonymousimage_profile, post_image,like,comment,save,share,more;
        private TextView anonymous,likes,publisher,description,title,category,date,time,shares,comments,cat1;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            anonymousimage_profile=itemView.findViewById(R.id.image_profile);
            ...
            anonymous=itemView.findViewById(R.id.username);
    ...
    private void isLiked(String postid, final ImageView imageView, final TextView likes, final TextView comments, final TextView shares, final EasyFlipView r1)
    {
    ...
    private void publisherInfo(final TextView anonymous, String userid, final ImageView save, final ImageView share , final TextView shares){
