 ...
 */
public class HanonymousFragment extends Fragment {

    private List<AnonymousPost> apostLists;
    private AnonymousPostAdapter postAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view =  inflater.inflate(R.layout.fragment_hanonymous, container, false);
    ...
    */
        ...
        postAdapter = new AnonymousPostAdapter(getContext(),apostLists);
    ...
    private void areadPosts()
    {
        //DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Posts");
        DatabaseReference areference = FirebaseDatabase.getInstance().getReference("Anonymous Posts");
