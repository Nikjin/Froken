 ...
 */
public class SanonymousFragment extends Fragment {

    RecyclerView recyclerView;
    AnonymousSearchAdapter searchAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_sanonymous, container, false);
        ...
        searchAdapter = new AnonymousSearchAdapter(getContext(), amData);
