...
import com.example.confesso.Adapter.CommentAdapter;
import com.example.confesso.Model.Comment;
...
public class CommentsActivity extends AppCompatActivity {
    ...
    //mei yeh islia use kr rha hu kyuki shared post activity mei issue aara thaaa baad mei jo intent se id aaari hai vo remove krdeni hai yaad se!
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       linearLayoutManager.setStackFromEnd(false);
        ...
        tts = new TextToSpeech(CommentsActivity.this, new TextToSpeech.OnInitListener() {
            @Override
       ...
       // getPostPublisher();
        ...
        username.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CommentsActivity.this, HomeActivity.class);
                intent.putExtra("publisherid", postpublisher1);
   ...
   */
    ...
    private void getImage()
    {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                //comment_profile.setImageResource(android.R.color.transparent);
    ...
    private void getPostDetails()
    {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                postpublisher1 = post.getPublisher();
                Glide.with(getApplicationContext()).load(post.getPostimage()).apply(new RequestOptions().placeholder(R.drawable.placeholder)).into(post_image);
    ...
    private void sendNotification(JSONObject notificationJo)
    {
        ...
        //enqeue the volley
        Volley.newRequestQueue(CommentsActivity.this).add(jsonObjectRequest);
