    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (flag==1)
                {
                    final ProgressDialog pd = new ProgressDialog(EditUsernameActivity.this);
                    ...
                    Toast.makeText(EditUsernameActivity.this,"Choose correct username",Toast.LENGTH_SHORT).show();
                }
